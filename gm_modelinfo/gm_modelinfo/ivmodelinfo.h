...
#define VMODELINFO_CLIENT_INTERFACE_VERSION	"VModelInfoClient005"
#define VMODELINFO_SERVER_INTERFACE_VERSION	"VModelInfoServer003"
...
public:
	...
	virtual void					InitDynamicModels( void ) = 0;
	virtual void  					ShutdownDynamicModels(void) = 0; //New
	virtual void  					AddDynamicModel(char  const*,int) = 0; //New
	virtual void  					ReferenceModel(int) = 0; //New
	virtual void  					UnreferenceModel(int) = 0; //New
	virtual void  					CleanupDynamicModels(bool) = 0; //New
