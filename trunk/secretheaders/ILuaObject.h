...
// This could be wrong, not sure where it's used either
class ILuaTable : public ILuaObject_001
{
	public:
		virtual void			Init(void) = 0;
		virtual void			SetFromGlobal(char  const*) = 0;
		virtual ILuaObject*		GetMember(char  const*,ILuaObject *) = 0;	// Assuming it returns an ILuaObject
		virtual ILuaObject*		GetMember(float,ILuaObject *) = 0;			// Assuming it returns an ILuaObject
		...
		virtual void			CopyFrom(ILuaObject *) = 0;
}
#endif // ILUAOBJECT_H