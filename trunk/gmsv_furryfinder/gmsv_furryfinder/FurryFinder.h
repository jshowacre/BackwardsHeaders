...
inline bool CSteamGameServerAPIContext::InitDetailed( CFurryFinder *pFurryFinder )
{
	...
	{
		Msg( "FurryFinder: g_pSteamClientGameServer is NULL!\n" );
		return false;
	}
	...
	{
		Msg( "FurryFinder: m_pSteamGameServer is NULL!\n" );
		return false;
	}
	...
	{
		Msg( "FurryFinder: m_pSteamGameServerUtils is NULL!\n" );
		return false;
	}
