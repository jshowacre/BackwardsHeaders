...
public:
	...
	virtual void SendMainMenuCommand( const char* ) = 0;
	virtual void CloseMessageDialog( vgui::VPANEL panel ) = 0;
	virtual void StartProgressBar() = 0;
	virtual void ContinueProgressBar( float ) = 0;
	virtual void StopProgressBar( bool, const char*, const char* ) = 0;
	virtual void SetProgressBarStatusText( const char* ) = 0;
	virtual void SetSecondaryProgressBar( float ) = 0;
	virtual void SetSecondaryProgressBarText( const char* ) = 0;
